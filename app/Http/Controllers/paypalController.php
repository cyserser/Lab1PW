...
class paypalController extends Controller
{
    ...
    public function payPalStatus(Request $request)
    {
        ...
        if ($result->getState() === 'approved') {
            ...
            //Insertar en BD
            $insertarPayment = new \App\payment(); // Sino el save no funciona
            ...
            Order::where('id',$orderID)->update(array('estado'=>'paid'));
            Invoice::where('id',$invoiceID)->update(array('estado'=>'paid'));
